...
function InfoForm({ changeToogle, numeroOrcamento, valueToogle }: props) {
  ...
  const [descricaoAtribuicaoTecnico, setDescricaoAtribuicaoTecnico] =
    useState<string>("");
      ...
      >
        <div className={style.cardConfirmTecnico}>
          ...
          <div className={style.container_input_descricao}>
            <div>
              <input
                id="txtDescricaoIniciarOrcamento"
                type="text"
                value={descricaoAtribuicaoTecnico}
                onChange={(e) =>
                  setDescricaoAtribuicaoTecnico(() => e.target.value)
                }
              />
        ...
        <div className={style.containerActions}>
          ...
          <div className={style.containerButtonDailyDir}>
            <button
              ...
              onClick={() => setToogleDiarioPrivado((current) => !current)}
            >
              <Icons.Book />
            </button>
          </div>
