...
function Info({ changeToogle, numeroOrcamento }: props) {
...
function InfoForm({ changeToogle, numeroOrcamento }: props) {
    const { Input } = InputUi();
    // const [data, setData] = useState<dataProps>();
    const [dataTecnico, setDataTecnico] = useState<tecnicoProps[]>([]);
    // const [loading, setLoading] = useState<boolean>(true);
    ...
    const { data, loading, setData, setLoading } = Fetchdata({ id: numeroOrcamento })
