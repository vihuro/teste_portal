...
function InfoForm({ changeToogle, numeroOrcamento, valueToogle }: props) {
  ...
  const [descricaoAtribuicaoTecnico, setDescricaoAtribuicaoTecnico] = useState<string>("");
    ...
    >
      ...
      >
        <div className={style.cardConfirmTecnico}>
          ...
          <div className={style.container_input_descricao}>
            <div>
              <input id="txtDescricaoIniciarOrcamento" type="text"
                value={descricaoAtribuicaoTecnico}
                onChange={(e) => setDescricaoAtribuicaoTecnico(() => e.target.value)} />
              <label htmlFor="txtDescricaoIniciarOrcamento">Descrição</label>
            </div>
                        ...
                        {dataBudget.statusSituacao.map((item, index) => (
                          <tr key={index}>
                            <td className={style.container_notification}>
                              <div
                                className={`${style.tag_notification} ${ValidateDiferenteDeNuloObservacao(
                                  item.observacao
                                ) && style["--contain"]
                                  }`}
                                onClick={() => {
